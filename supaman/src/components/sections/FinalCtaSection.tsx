    ...
    <>
      ...
      >
        <div className={sectionStyles.background}>
          <picture className={mediaStyles.responsivePicture}>
            <source
        ...
        <div className={`${styles.contentWrapper} ${styles.section}`}>
          <h2 className={`${textBase.text} ${textStyles.headingLarge}`}>
            AI that works everywhere you work
          </h2>
          <a
            className={`${linkStyles.link} ${buttonStyles.button} ${buttonStyles.primaryHeart} ${styles.ctaButton}`}
            aria-disabled="false"
            data-color-scheme="dark"
            href="https://superhuman.com/auth/signup?screen_hint=signup"
          >
            <span className={buttonStyles.buttonContent}>
              <span className={`${textBase.text} ${buttonStyles.text} ${styles.ctaButtonText}`}>
                Get Superhuman
              </span>
            </span>
          </a>
